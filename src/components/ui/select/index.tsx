...
export const Select: React.FC<{
  ...
  options: Option[];
  value: any;
  selectChange?: (v: any) => void;
}> = ({ label, options, value, selectChange }) => {
  ...
  const _selectChange = (value: Option) => {
    setSelected(value);
    if (selectChange !== undefined) selectChange(value.value);
    setToggle(false);
  };
